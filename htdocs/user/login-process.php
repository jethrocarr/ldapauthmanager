...
if (user_online())
{
	...
	$_SESSION["error"]["username_ldapauthmanager"] = "error";
	$_SESSION["error"]["password_ldapauthmanager"] = "error";
...
else
{
	...
	else
	{
		...
		if (!$_SESSION["error"]["message"])
		{
			...
			$_SESSION["error"]["username_ldapauthmanager-error"] = 1;
			$_SESSION["error"]["password_ldapauthmanager-error"] = 1;
		}

		if ($result == -3)
		{
			$_SESSION["error"]["instance_ldapauthmanager-error"] = 1;
		}
